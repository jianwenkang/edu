...
<fieldset id="custom">
    ...
    <p>所在地区：
        <select class="first" data-value="1" data-first-title="选择1" disabled="disabled" name="first" data-url="data/first.json" data-json-name="myname" data-json-value="myvalue"></select>
        <select class="second" data-value="2" data-first-title="选择2" disabled="disabled" data-url="data/second.json" data-query-name="cuname" data-json-name="sename" data-json-value="sevalue" data-json-space="mydata"></select>
